...
Neue Charaktere beginnen das Spiel mit 3W6 x 10 Münzen, mit denen sie ihre Ausrüstung kaufen können. Außerdem besitzen sie jeder die Kleidung, die sie tragen und eine Waffe, die ihnen ihre Klasse erlaubt.
...
Zeit im Spiel wird vor allem auf zwei Arten nachgehalten - **Momente** (Runden) und **Minuten** (Züge). **Momente** werden für Kampf- oder Actionszenen benutzt und **Minuten** beim Erkunden und sonst während des Abenteuers. Ein SL kann die Zeit auch je nach Bedarf schneller verstreichen lassen und **Minuten** durch **Stunden**, **Tage** oder gar **Monate** ersetzen, wenn das Abenteuer es erfordert.
...
Der Wert für **Trefferwürfel (TW)** entspricht der Stufe eines Monsters und somit der Anzahl von W8, mit denen seine TP ausgewürfelt werden.
...
*Der SL entscheidet, was davon gilt und wir empfehlen, für den Verlauf einer Kampagne bei der gewählten Vorgehensweise zu bleiben - und der SL sollte das seinen Spielern vorher klar ansagen, damit sie sich auf die 'Etappen' einstellen können.*
...
Untote Monster, die die Kleriker **bannen** konnten, müssen alle ihre Bewegungen dazu benutzen (und alle Handlungen in Bewegungen umwandeln), um sich für 2W4 **Momente** vom Kleriker zu entfernen, nachdem sie von **Bannen** betroffen wurden.

## Vorratswürfel

Alle Gegenstände im Abschnitt zu Ausrüstung, für die ein **Vorratswürfel** angegeben ist, sind Verbrauchsgegenstände mit begrenzter Anzahl. Wenn solch ein Gegenstand benutzt wurde, wird in der nächsten **Minute** (Runde) sein **Vorratswürfel** gewürfelt. Wenn das Ergebnis 1-2 ist, wird der Vorratswürfel nach dem folgenden Schema verringert:
...
Diebe würfeln mit einem **Vorteil** bei **GES**-Proben um Schaden oder Effekte von Fallen und magischen Gegenständen zu vermeiden.
...
Nachdem ein Spruch gewirkt wurde, müssen Kleriker/Zauberer eine Probe auf **WEI**/**INT** würfeln und dabei die Stufe des Spruchs auf das Würfelergebnis addieren. Wenn die Probe misslingt, verlieren sie einen täglichen Spruch der Stufe des Zaubers. Wenn ein Zauberspruch aus dem Gedächtnis eingesetzt wird, ist er danach nicht vergessen.
...
| Grizzlybär             |    4     | 2 Klauen (1W3) + wenn beide treffen Umklammerung  für 1W8 Schaden.                                                                                   |
...
| Eulenbär               |    5     | 2 Klauen (1W6) + 1 Biss (2W6) + Umklammerung für 2W8 wenn beim Ausweichen 1-4 gewürfelt.                                                             |
